 ...
 */
package domicilioFiscal.emisor;  
...
public class comprobante extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"comprobante\",\"namespace\":\"domicilioFiscal.emisor\",\"fields\":[{\"name\":\"noExterior\",\"type\":\"string\"},{\"name\":\"estado\",\"type\":\"string\"},{\"name\":\"codigoPostal\",\"type\":\"string\"},{\"name\":\"municipio\",\"type\":\"string\"},{\"name\":\"calle\",\"type\":\"string\"},{\"name\":\"localidad\",\"type\":\"string\"},{\"name\":\"colonia\",\"type\":\"string\"},{\"name\":\"pais\",\"type\":\"string\"}]}");
  ...
  @Deprecated public java.lang.CharSequence localidad;
   ...
   */
  public comprobante(java.lang.CharSequence noExterior, java.lang.CharSequence estado, java.lang.CharSequence codigoPostal, java.lang.CharSequence municipio, java.lang.CharSequence calle, java.lang.CharSequence localidad, java.lang.CharSequence colonia, java.lang.CharSequence pais) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: localidad = (java.lang.CharSequence)value$; break;
    case 6: colonia = (java.lang.CharSequence)value$; break;
    case 7: pais = (java.lang.CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static domicilioFiscal.emisor.comprobante.Builder newBuilder() {
    return new domicilioFiscal.emisor.comprobante.Builder();
  }
  
  /** Creates a new comprobante RecordBuilder by copying an existing Builder */
  public static domicilioFiscal.emisor.comprobante.Builder newBuilder(domicilioFiscal.emisor.comprobante.Builder other) {
    return new domicilioFiscal.emisor.comprobante.Builder(other);
  }
  
  /** Creates a new comprobante RecordBuilder by copying an existing comprobante instance */
  public static domicilioFiscal.emisor.comprobante.Builder newBuilder(domicilioFiscal.emisor.comprobante other) {
    return new domicilioFiscal.emisor.comprobante.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<comprobante>
    ...
    private Builder() {
      super(domicilioFiscal.emisor.comprobante.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(domicilioFiscal.emisor.comprobante.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[5], other.localidad)) {
        this.localidad = data().deepCopy(fields()[5].schema(), other.localidad);
        fieldSetFlags()[5] = true;
      }
      if (isValidValue(fields()[6], other.colonia)) {
        this.colonia = data().deepCopy(fields()[6].schema(), other.colonia);
        fieldSetFlags()[6] = true;
      }
      if (isValidValue(fields()[7], other.pais)) {
        this.pais = data().deepCopy(fields()[7].schema(), other.pais);
        fieldSetFlags()[7] = true;
      }
    }
    
    /** Creates a Builder by copying an existing comprobante instance */
    private Builder(domicilioFiscal.emisor.comprobante other) {
            super(domicilioFiscal.emisor.comprobante.SCHEMA$);
      if (isValidValue(fields()[0], other.noExterior)) {
        this.noExterior = data().deepCopy(fields()[0].schema(), other.noExterior);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'noExterior' field */
    public domicilioFiscal.emisor.comprobante.Builder setNoExterior(java.lang.CharSequence value) {
    ...
    public domicilioFiscal.emisor.comprobante.Builder clearNoExterior() {
      noExterior = null;
    ...
    /** Sets the value of the 'estado' field */
    public domicilioFiscal.emisor.comprobante.Builder setEstado(java.lang.CharSequence value) {
    ...
    public domicilioFiscal.emisor.comprobante.Builder clearEstado() {
      estado = null;
    ...
    /** Sets the value of the 'codigoPostal' field */
    public domicilioFiscal.emisor.comprobante.Builder setCodigoPostal(java.lang.CharSequence value) {
    ...
    public domicilioFiscal.emisor.comprobante.Builder clearCodigoPostal() {
      codigoPostal = null;
    ...
    /** Sets the value of the 'municipio' field */
    public domicilioFiscal.emisor.comprobante.Builder setMunicipio(java.lang.CharSequence value) {
    ...
    public domicilioFiscal.emisor.comprobante.Builder clearMunicipio() {
      municipio = null;
    ...
    /** Sets the value of the 'calle' field */
    public domicilioFiscal.emisor.comprobante.Builder setCalle(java.lang.CharSequence value) {
    ...
    public domicilioFiscal.emisor.comprobante.Builder clearCalle() {
      calle = null;
    ...
    /** Sets the value of the 'localidad' field */
    public domicilioFiscal.emisor.comprobante.Builder setLocalidad(java.lang.CharSequence value) {
    ...
    public domicilioFiscal.emisor.comprobante.Builder clearLocalidad() {
      localidad = null;
    ...
    /** Sets the value of the 'colonia' field */
    public domicilioFiscal.emisor.comprobante.Builder setColonia(java.lang.CharSequence value) {
    ...
    public domicilioFiscal.emisor.comprobante.Builder clearColonia() {
      colonia = null;
    ...
    /** Sets the value of the 'pais' field */
    public domicilioFiscal.emisor.comprobante.Builder setPais(java.lang.CharSequence value) {
    ...
    public domicilioFiscal.emisor.comprobante.Builder clearPais() {
      pais = null;
    ...
    public comprobante build() {
      try {
        ...
        record.localidad = fieldSetFlags()[5] ? this.localidad : (java.lang.CharSequence) defaultValue(fields()[5]);
        record.colonia = fieldSetFlags()[6] ? this.colonia : (java.lang.CharSequence) defaultValue(fields()[6]);
        record.pais = fieldSetFlags()[7] ? this.pais : (java.lang.CharSequence) defaultValue(fields()[7]);
        return record;
      } catch (Exception e) {
